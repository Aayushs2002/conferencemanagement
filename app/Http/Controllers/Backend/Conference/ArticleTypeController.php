...
class ArticleTypeController extends Controller
{
    ...
    public function settingSubmit(Request $request, $society, $conference)
    {
        ...
        $rules = [
            ...
            'title_scoring_enabled' => 'nullable|boolean',
            'title_max_marks' => 'nullable|numeric|min:0',
            'title_reviewer_instruction' => 'nullable|string',
        ...
        $messages = [
            ...
            'title_max_marks.numeric' => 'The title maximum marks must be a number.',
            'title_max_marks.min' => 'The title maximum marks must be at least 0.',
        ...
        try {
            ...
            $data = [
                ...
                'title_scoring_enabled' => $request->has('title_scoring_enabled') ? 1 : 0,
                'title_max_marks' => $request->title_max_marks ?? 0,
                'title_reviewer_instruction' => $request->title_reviewer_instruction,
