...
namespace App\Services\HBL\Api;
...
class Payment extends ActionRequest
{
    ...
    public function ExecuteFormJose($mid, $api_key, $curr, $amt, $threeD, $success_url, $failed_url, $cancel_url, $backend_url, $access_token, $merchant_signing_private_key, $paco_encryption_public_key, $merchant_decryption_private_key, $paco_signing_public_key): string
    {
        ...
        $stringPayload = json_encode($payload);
        // $signingKey = $this->GetPrivateKey(SecurityData::$MerchantSigningPrivateKey);
        $signingKey = $this->GetPrivateKey($merchant_signing_private_key);
        // $encryptingKey = $this->GetPublicKey(SecurityData::$PacoEncryptionPublicKey);
        $encryptingKey = $this->GetPublicKey($paco_encryption_public_key);
        ...
        // dd($token,$decryptingKey,$signatureVerificationKey);
        return $this->DecryptToken($token, $decryptingKey, $signatureVerificationKey);
    }
}
