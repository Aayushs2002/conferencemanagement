...
//                 ).value,
//                 new_post = document.querySelector(
//                     ".add-new-record .dt-post"
//                 ).value,
//                 new_email = document.querySelector(
//                     ".add-new-record .dt-email"
//                 ).value,
//                 new_date = document.querySelector(
//                     ".add-new-record .dt-date"
//                 ).value,
//                 new_salary = document.querySelector(
//                     ".add-new-record .dt-salary"
//                 ).value;
...
//     const dt_complex_header_table =
//         document.querySelector(".dt-complex-header");
//     let dt_complex;
...
//             language: {
//                 url:
//                     "https://cdn.datatables.net/plug-ins/1.11.5/i18n/de-" +
//                     lang +
//                     ".json",
//                 paginate: {
//                     next: '<i class="icon-base ti tabler-chevron-right scaleX-n1-rtl icon-sm"></i>',
//                     previous:
//                         '<i class="icon-base ti tabler-chevron-left scaleX-n1-rtl icon-sm"></i>',
//                 },
//             },
//             order: [[2, "desc"]],
//             displayLength: 7,
