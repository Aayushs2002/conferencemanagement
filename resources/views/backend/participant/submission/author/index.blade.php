           ...
           <div class="card-datatable table-responsive pt-0">
               <div class="row card-header flex-column flex-md-row border-bottom mx-0 px-3">
                   <div
                       ...
                       <h5 class="card-title mb-0 text-md-start text-center pb-md-0 pb-6">Authors of {{ $submission->title }}
                       </h5>
                   </div>
       ...
       <script>
           $(document).ready(function() {
               ...
               $(document).on("click", ".addAuthor", function(e) {
                   e.preventDefault();
                   var url =
                       '{{ route('my-society.conference.submission.author.create', [$society, $conference]) }}';
                   var _token = '{{ csrf_token() }}';
