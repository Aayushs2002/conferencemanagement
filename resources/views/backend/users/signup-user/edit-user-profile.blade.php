<div class="modal-body ">
    ...
    <div class="">
        <h5 class=" mb-4 " style="background: white;">Edit Profile<span class="text-danger">(User
                Name:
        ...
        <form id="verifyForm">
            ...
            <div class="row">
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <span class="mr-3">
                        <input type="radio" @if (old('gender', $user->userDetail->gender) == 1) checked @endif id="male"
                            name="gender" value="1">
                        <label for="male">Male</label>
                    </span>
                    <span class="mr-3">
                        <input type="radio" @if (old('gender', $user->userDetail->gender) == 2) checked @endif id="female"
                            name="gender" value="2" style="margin-left: 10px;">
                        <label for="female">Female</label>
                    </span>
                    <span>
                        <input type="radio" @if (old('gender', $user->userDetail->gender) == 3) checked @endif id="other"
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <select name="name_prefix_id" class="form-control" id="name_prefix_id" required>
                        ...
                        @foreach ($prefixesAll as $prefix)
                            <option value="{{ $prefix->id }}" @selected(old('name_prefix_id', $user->userDetail->name_prefix_id) == $prefix->id)>
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <input type="text" class="form-control @error('f_name') is-invalid @enderror" name="f_name"
                        id="f_name" value="{{ old('f_name', $user->f_name) }}" placeholder="Enter first name"
                        required />
                    @error('f_name')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <input type="text" class="form-control @error('m_name') is-invalid @enderror" name="m_name"
                        id="m_name" value="{{ old('m_name', $user->m_name) }}" placeholder="Enter first name" />
                    @error('m_name')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="col-md-4 form-group mb-3">
                    ...
                    <input type="text" class="form-control @error('l_name') is-invalid @enderror" name="l_name"
                        id="l_name" value="{{ old('l_name', $user->l_name) }}" placeholder="Enter first name"
                        required />
                    @error('l_name')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <input type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                        id="email" value="{{ old('email', $user->email) }}" placeholder="Enter email" required />
                    @error('email')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="col-md-4 form-group mb-3">
                    ...
                    <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone"
                        id="phone" value="{{ old('phone', $user->userDetail->phone) }}" placeholder="Enter phone"
                        required />
                    @error('phone')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="col-md-4 form-group mb-3">
                    <label for="institute_address">Institute Address <code>*</code></label>
                    <input type="text" class="form-control @error('institute_address') is-invalid @enderror"
                        name="institute_address" id="institute_address"
                        value="{{ old('address', $user->userDetail->institute_address) }}"
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <input type="text" class="form-control @error('council_number') is-invalid @enderror"
                        ...
                        value="{{ old('council_number', $user->userDetail->council_number) }}"
                ...
                <div class="col-md-4 form-group mb-3">
                    ...
                    <select class="form-control" name="country_id" id="country_id" required>
                        ...
                        @foreach ($countries as $country)
                            <option value="{{ $country->id }}" @selected(old('country_id', $user->userDetail->country_id) == $country->id)>
                ...
                <div class="col-md-12 text-end">
                    <button type="submit" id="editRegistrant" class="btn btn-primary">Submit</button>
                </div>
            </div>
        </form>
    </div>
