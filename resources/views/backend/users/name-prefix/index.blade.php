        ...
        <div class="card-datatable table-responsive pt-0">
            <div class="row card-header flex-column flex-md-row border-bottom mx-0 px-3">
                <div class="d-md-flex justify-content-between align-items-center dt-layout-start col-md-auto me-auto mt-0">
                    <h5 class="card-title mb-0 text-md-start text-center pb-md-0 pb-6">Name Prefix</h5>
                </div>
                <div class="d-md-flex justify-content-between align-items-center dt-layout-end col-md-auto ms-auto mt-0">
                    <div class="dt-buttons btn-group flex-wrap mb-0">
                        ...
                        <a href="{{ route('name-prefix.create') }}" class="btn btn-primary" tabindex="0">
            ...
            <table class="datatables-basic table">
                ...
                <tbody>
                    @foreach ($name_prefixs as $name_prefix)
                        <tr>
                            <th scope="row">{{ $loop->iteration }}</th>
                            <td>{{ $name_prefix->prefix }}</td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('name-prefix.edit', $name_prefix->id) }}"><i
