    ...
    <ul class="menu-inner py-1">
                ...
                <li
                    ...
                    <ul class="menu-sub">
                        ...
                        @if (auth()->user()->hasConferencePermissionBlade($conference, 'View Certificate Setting'))
                            <li
                                class="menu-item {{ request()->segment(6) == 'conference-certificate' ? 'active' : '' }}">
        ...
        @if (current_user()->type == 3)
            ...
            @if (feature_enabled('workshop-management', getSociety(request()->segment(2))))
                ...
                @if ($conferenceSetting?->workshop_application_deadline)
                    <li
            ...
            @endif
            @if (feature_enabled('abstract-submission-management', getSociety(request()->segment(2))))
                <li
        ...
        {{-- @if (current_user()->type != 3) --}}
        @if (feature_enabled('scientific-session-management', getSociety(request()->segment(2))))
            @if (auth()->user()->hasAnyConferencePermission($conference, [
                ...
                <li class="menu-item {{ request()->segment(5) == 'workshop' ? 'active open' : '' }}">
                    ...
                    <ul class="menu-sub">
                        ...
                        @if (auth()->user()->hasConferencePermissionBlade($conference, 'Regster New User'))
                            <li
                                class="menu-item {{ request()->segment(7) == 'register-for-new-user' ? 'active' : '' }}">
                        ...
                        @if (auth()->user()->hasConferencePermissionBlade($conference, 'View Workshop Pass Setting'))
                            <li
                                class="menu-item {{ request()->segment(6) == 'workshop-pass-settings' ? 'active' : '' }}">
                ...
                <li class="menu-item {{ request()->segment(5) == 'committee' ? 'active open' : '' }}">
                    ...
                    <ul class="menu-sub">
                        ...
                        @if (auth()->user()->hasConferencePermissionBlade($conference, 'View Committee Designation'))
                            <li
                                class="menu-item {{ request()->segment(6) == 'committe-designation' ? 'active' : '' }}">
        ...
        @if (feature_enabled('sponsor-management', getSociety(request()->segment(2))))
        ...
        @if (feature_enabled('faq-management', getSociety(request()->segment(2))))
        ...
        @if (feature_enabled('download-management', getSociety(request()->segment(2))))
