        ...
        <div class="card-datatable table-responsive pt-0">
            <div class="row card-header flex-column flex-md-row border-bottom mx-0 px-3">
                <div class="d-md-flex justify-content-between align-items-center dt-layout-start col-md-auto me-auto mt-0">
                    <h5 class="card-title mb-0 text-md-start text-center pb-md-0 pb-6">Committee Designation</h5>
                </div>
                <div class="d-md-flex justify-content-between align-items-center dt-layout-end col-md-auto ms-auto mt-0">
                    <div class="dt-buttons btn-group flex-wrap mb-0">
                        ...
                        @if (auth()->user()->hasConferencePermissionBlade(getConference(request()->segment(4)), 'Add Committee Designation'))
                            <a href="{{ route('committe-designation.create', [$society, $conference]) }}"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    @if (auth()->user()->hasConferencePermissionBlade(getConference(request()->segment(4)), 'Edit Committee Designation'))
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                                href="{{ route('committe-designation.edit', [$society, $conference, $designation->id]) }}"><i
