...
<head>
    ...
    <title>Worskshop Attendance Portal</title>
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="profile-card">
            ...
            <h2 class="user-name">John Doe Smith</h2>
            <p class="user-title">Workshop Participant</p>
        </div>
        ...
        document.getElementById('takeAttendance').addEventListener('click', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch('{{ route('workshop.workshop-registration.takeAttendance') }}', {
                            method: 'POST',
                            headers: {
