        ...
        <div class="card-datatable table-responsive pt-0">
            <div class="row card-header flex-column flex-md-row border-bottom mx-0 px-3">
                <div class="d-md-flex justify-content-between align-items-center dt-layout-start col-md-auto me-auto mt-0">
                    <h5 class="card-title mb-0 text-md-start text-center pb-md-0 pb-6">Scientific Session Poll</h5>
                </div>
                <div class="d-md-flex justify-content-between align-items-center dt-layout-end col-md-auto ms-auto mt-0">
                    <div class="dt-buttons btn-group flex-wrap mb-0">
                        ...
                        @if (auth()->user()->hasConferencePermissionBlade(getConference(request()->segment(4)), 'Create Poll'))
                            <a href="{{ route('poll.create', [$society, $conference, $id]) }}" class="btn btn-primary"
                                tabindex="0">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        @if (auth()->user()->hasConferencePermissionBlade(getConference(request()->segment(4)), 'Edit Poll'))
                                            <a class="dropdown-item"
                                                href="{{ route('poll.edit', [$society, $conference, $poll->id]) }}"><i
                                                    class="icon-base ti tabler-pencil me-1"></i> Edit</a>
                                        @endif
                                        <hr>
                                        @if (auth()->user()->hasConferencePermissionBlade(getConference(request()->segment(4)), 'Delete Poll'))
                                            <form action="{{ route('poll.destroy', [$society, $conference, $poll->id]) }}"
                                                method="POST">
                                                @method('delete')
                                                @csrf
