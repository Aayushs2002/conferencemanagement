    ...
    <div class="card">
        ...
        <div class="card-datatable table-responsive pt-0">
            <div class="row card-header flex-column flex-md-row border-bottom mx-0 px-3">
                ...
                <div class="d-md-flex justify-content-between align-items-center dt-layout-end col-md-auto ms-auto mt-0">
                    <div class="dt-buttons btn-group flex-wrap mb-0">
                        ...
                        @if (auth()->user()->hasConferencePermissionBlade($conference, 'Add Category/Major Track'))
                            <a href="{{ route('submission.category-majortrack.create', [$society, $conference]) }}"
            ...
            <table class="datatables-basic table">
                ...
                <tbody>
                    @foreach ($submissionCategoryMajortracks as $submissionCategoryMajortrack)
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        @if (auth()->user()->hasConferencePermissionBlade($conference, 'Edit Category/Major Track'))
                                            <a class="dropdown-item"
                                                href="{{ route('submission.category-majortrack.edit', [$society, $conference, $submissionCategoryMajortrack->id]) }}"><i
                                                    class="icon-base ti tabler-pencil me-1"></i> Edit</a>
                                        @endif
                                        <hr>
                                        @if (auth()->user()->hasConferencePermissionBlade($conference, 'Delete Category/Major Track'))
                                            <form
                                                action="{{ route('submission.category-majortrack.destroy', [$society, $conference, $submissionCategoryMajortrack->id]) }}"
                                                method="POST">
                                                @method('delete')
                                                @csrf
