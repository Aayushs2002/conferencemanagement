        ...
        <div class="card-datatable table-responsive pt-0">
            <div class="row card-header flex-column flex-md-row border-bottom mx-0 px-3">
                <div class="d-md-flex justify-content-between align-items-center dt-layout-start col-md-auto me-auto mt-0">
                    <h5 class="card-title mb-0 text-md-start text-center pb-md-0 pb-6">Why Choose Us</h5>
                </div>
                <div class="d-md-flex justify-content-between align-items-center dt-layout-end col-md-auto ms-auto mt-0">
                    <div class="dt-buttons btn-group flex-wrap mb-0">
                        <a href="{{ route('why-choose-us.create') }}" class="btn btn-primary" tabindex="0">
                ...
                <tbody>
                    ...
                    @foreach ($whyChooseUs as $whyChoose)
                        <tr>
                            ...
                            <td> <a href="{{ asset('storage/whyChooseUs/image/' . $whyChoose->image) }}"
                                    target="_blank"><img src="{{ asset('storage/whyChooseUs/image/' . $whyChoose->image) }}"
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('why-choose-us.edit', $whyChoose->id) }}"><i
                                        ...
                                        <hr>
                                        <form action="{{ route('why-choose-us.destroy', $whyChoose->id) }}" method="POST">
                                            @method('delete')
                                            @csrf
